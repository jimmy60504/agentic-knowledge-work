...
| 段落 | 內容 |
|---|---|
| 前半段 | AI 放大器、學習切入點、請教與交辦、自己的洞見、內容演變、外部化與資料夾用途、交付責任；用版本差異串起概念 |
...
講師操作一段，學員跟做一段。每一步都打開實際檔案確認，再進到下一步；對話用自己的說法，檔名與位置依當下工作資料夾決定。

#### 一、打開工作資料夾，聊背景並保存起點

開啟獨立練習資料夾，放入可用原稿的副本。先聊這次想做什麼、目前的想法與理由，再問 agent 有什麼補充；已有整理方式就打開範例，請它沿用。

例如：「我想先講新同仁常遇到的問題，再說明流程。你覺得這樣安排還缺什麼？」看過回應後，補充背景並決定要調整的地方。

請 agent 把原有想法、目前背景與未定事項整理成 Markdown 保存。打開檔案，確認位置正確、自己的意思有留下來；若無法讀寫，先用講師備援材料排除問題。
