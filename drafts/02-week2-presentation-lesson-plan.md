...
補入自己對主題的理解、經驗與實際範例，直接編輯或請 agent 改寫。引用資料、圖片或案例 時保留來源，未完成處標記待補；確認自己能說明內容。
...
舊 lesson 取捨與來源集中於 [第二週移出主題與後續用途](06-week2-deferred-topics.md)，舊 lesson 原文保留在 Git 歷史。2026-09-07 已依本稿重寫第二週文章版，逐頁稿仍留 drafts；尚未部署網站或製作 PPTX。
