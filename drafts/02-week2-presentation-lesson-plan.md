...
先從自己需要哪種協助開始，再以研究簡報為練習，讓學員看到討論如何接到搜尋、保存材料、整理 draft 與製作 PPT。人決定方向、採用哪些內容與如何修改，agent 接續執行，把想講的內容做成自己能說明、能接續編輯的成果。

| 段落 | 安排 |
|---|---|
| 開場 | Agent 可以幫什麼：補知識、協助不熟悉的工具操作、處理重複雜工、協助檢查 |
| 前半段 | 能力互補 → 請教與交辦 → 用簡報示範產出物與兩個迴圈 → 保存過程 |
...
工作卡住的原因不只一種：可能還不知道方法，也可能有想法卻不熟悉工具，或只是有一批重複工作不想逐項處理。先從自己需要哪種協助開始看：
...
同一件工作可能需要幾種協助。請學員說一件想完成的事，指出目前卡在哪裡；例子可以來自研究、資料處理、工具製作或日常工作。

口述接回本週核心：「今天我們會讓 agent 把想法做成成果。你決定方向，它協助查找、操作與製作；看到結果，再一起修改。」接著說明兩種能力如何配合，之後選做簡報來完整練習一次。

## 前半段：概念與流程

### 一、AI 如何配合自己的能力與需要

要把剛才的需求說清楚，需要兩種能力配合：理解工作的方法，也熟悉 agent 與工具的能力。
...
回到開場選的工作，想想需要補哪一邊的能力。交付的內容仍要自己能判斷與說明。
...
接下來選做研究簡報，練習從想法到成果的完整過程。這件工作同時包含找材料、形成觀點、整理內容與製作版面，可以把剛才幾種協助連起來。
...
回到開場選的協助需求，再看自己這次簡報的前後成果：補上了什麼內容、哪一項採用或刪除是自己的判斷，以及哪些搜尋、整理或排版工作交給了 agent。用實際版本指出變化，不預設每個步驟都已省時。

最後以「讓 agent 把你的想法做成成果」收束：這次留下可回查的材料、自己的 draft 與可編輯投影片，下次能接著修改。將一項值得沿用的要求補進 `AGENTS.md`，講師收集下次想處理的工作，練習在課堂完成。
