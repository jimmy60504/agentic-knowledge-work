...
可以用「領域知識 × 駕馭 agent 的能力」理解 AI 放大器。乘號是兩種能力配合的比喻：領域知識幫助我們判斷方向與結果；駕馭 agent 的能力，幫助我們提供材料、說明要求，透過嘗試與回饋把想法做出來。
...
熟悉工作，可以先交辦既有流程的一段；不熟悉主題，也可以藉由查閱、試用與比較累積經驗。研究提供了一個例子：5,172 位客服人員導入 AI 助理後，每小時解決問題數平均增加 15%，較少經驗、較低原始技能者改善較多。這說明 AI 也可能補足經驗，不能從放大器的比喻推論原本越強就一定受益越多。
...
| 產出物 | 用途與同主題示例 |
|---|---|
| 論點 | 保存主張、依據、順序與棄案理由。例如「AI 也可能補足經驗」，連到客服研究，捨棄「人人同等受益」的說法。 |
...
本課自繪的材料判斷方式。把候選圖像放在相關想法旁，記下用途；支持不足就縮小主張或補查。前面的客服研究可用來示範，如何從「原本越強，受益越多」改成「AI 也可能補足經驗，效果依情境而異」。
...
**補入依據後（整理自研究）：** 一項客服研究發現，導入 AI 助理後，每小時解決問題數平均增加 15%，較少經驗者受益較多；其他工作情境是否適用，仍需另外確認。

來源：[*Generative AI at Work*，2024 v2 摘要](https://arxiv.org/abs/2304.11771v2)。前句刻意過度概括，後句補進情境、結果與限制。現場用實作主題的一句話做同樣修改。
...
例如沿用客服案例，畫面放「AI 也可能補足經驗」與 Figure 3，口述交代客服情境、分組差異及適用限制。原圖需保留座標與圖說；若投影難以閱讀，改用文字摘要，不勉強縮小。
