...
講師帶法：示範幾次短的來回，在轉成交辦時說明「現在想清楚要做什麼了，接著把這次一定要符合的條件交代清楚」。下列短句只是對話例子，學員用自己的話說；放寬做法的目的，是保留探索其他方案的空間，不預先保證一定比原想像更好。
...
講師先開啟或指定獨立練習資料夾，把適合練習的原稿副本交給 agent，像平常討論工作一樣說明背景。已有想法的人先說自己的版本與理由；從空白開始的人也可以先聊零碎的觀察，不必先形成完整主張。

例如要向新同仁介紹工作，可以先說：「我想先講大家最容易遇到的問題，再說明流程，因為只講步驟可能不容易理解。你覺得這樣安排還缺什麼？」讓 agent 沿著自己的想法補充，或說明不同安排的理由，再由自己決定要怎麼改。
...
這一段用請教的心態，順著剛才的討論，問 AI 還有哪些值得了解的角度或關鍵字，也追問為什麼這些方法可能有用。看到有興趣的方向就繼續問、找資料；覺得太遠或用不到，就說明原因，再把討論拉回這次需要。

講師用一份實際讀到的材料示範，和 agent 討論它對這次簡報有什麼幫助。自己想到的經驗或觀點也直接補進對話，和新資料比較；採用或改變原看法時，說明自己的理由，再請它協助整理。當場無法查找時，就用講師準備的公開材料。
...
打開故事線，確認採用的材料、自己的觀點與排列方式都清楚；也對照原始想法，看看哪些保留、哪些改變，以及這些變化是否符合自己的判斷。未採用的資料仍留在素材筆記中，以後可能有別的用途。

#### 五、逐頁起草，再把內容改成自己的話

故事線有了，就轉成交辦，請 agent 沿著它展開逐頁草稿。先講清楚這次的受眾、內容範圍與頁數，已存下來的要求就讀取沿用；讓它提出適合的寫法，再逐頁看哪裡需要補充。
...
內容大致清楚後，交代這次的用途、範圍、頁數、可編輯 PowerPoint 等必要條件，以及哪些事實與主張必須保留。版面安排與表達手法可以讓 agent 建議，試一版再看。

例如可以說：「就用剛才確認的內容，做成五頁以內、可以接著編輯的 PowerPoint，給新同仁看。先介紹基本流程，進階情況這次先不放。版面你先試一個適合的做法。」這是界定本次成果的對話示例，實際條件依任務決定。

若已有必須遵守的版型或格式，就明確交代；只是自己的初步偏好，可以先說希望達到的效果，看看 agent 有沒有更合適的方案。
...
回想剛才何時在請教、何時轉成交辦：聊背景、追問建議，把方向與必要限制說清楚，再看成果、補充修改，最後把結果存下來。請學員指出一項採納或刪除的內容、一處自己補充的觀點，以及一項修改後值得保留的要求。這些取捨讓簡報逐漸符合自己的目的，也讓下次可以從留下的檔案接續。
