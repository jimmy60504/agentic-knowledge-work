...
> 2026-09-07 圖文整合草案：新增來源為 [AI 放大器的文獻與圖片蒐集測試](../kb/ai-amplifier-evidence-and-visuals.md)及 `工作紀錄.md` 的「文獻與圖片提早到建立論點階段」討論。段落中的「畫面草案」為備課用：已取得圖片直接嵌入；自繪示意圖標明性質；待找圖片寫明用途、來源方向與完成條件。尚未同步正式教材或 PPTX。

> 本次逐段補充另見 [圖文與中英文來源選用紀錄](../kb/week2-paragraph-evidence-and-visuals.md)。以下畫面可供挑選，並不代表每張都要增加一頁；「優先」建議進入主線，「備選」供試講後取捨。圖片的取得、修改與授權集中在 [素材來源表](../assets/week2-enrichment/README.md)。
...
> **畫面取捨：** 本週安排以簡短路線與最後會取得的成果說明即可；成果預覽沿用後面的「三種產出物」圖，不另找裝飾照片。三到五頁指學員實作成果，並非本教案所有畫面的頁數。
...
> **台灣觀點，口述補充：** 孫以瀚在 2026-05-11 的研究寫作講座，將形成問題、篩選與判斷、後續執行列為人的貢獻。這可用來補充本段的「自己要能判斷與說明」；屬講者的實務觀點，不是效益研究。[講座原稿，PDF 第 61 頁](https://ethics.moe.edu.tw/files/resource/lecture/20260511/20260511_lecture_20260508.pdf#page=61)。原頁放在下方「怎麼和 agent 合作」，本段不重複顯示。
...
**優先：台灣講者原頁。** 先讓聽眾看原作者如何提出問題，再接回自己的工作：請 agent 提出方法後，自己讀懂並判斷是否適用。

![孫以瀚講座第 61 頁：他人幫助，但我主導](../assets/week2-enrichment/sun-human-judgment-page61.png)

來源：孫以瀚，〈運用生成式 AI 輔助撰寫研究計畫及論文：心態、技巧、學倫〉，2026-05-11，教育部臺灣學術倫理教育資源中心提供，[PDF 第 61 頁](https://ethics.moe.edu.tw/files/resource/lecture/20260511/20260511_lecture_20260508.pdf#page=61)。原稿第 1 頁註明歡迎分享；此處保留整頁，未修改。講者亦表明是個人意見，不當成教育部的規範或研究定論。
...
![同一個想法分別保存為論點、文章與投影片，並列各自內容](../assets/week2-enrichment/three-artifacts.svg)

**優先：具體內容對照。** 用這張圖取代表格也可以；三份內容沿用前面的客服案例，讓學員看到實際差別。圖為課程自繪示意，三種產出物是本課安排。
...
![數發部手冊第 25 頁節錄：清楚目標、問題範圍、可行動性及提問對照](../assets/week2-enrichment/moda-problem-definition-page25.png)

**優先：挑一組提問對照即可。** 讓學員比較籠統的效率要求和具體工作情境，再用自己的工作改說一次。來源：數位發展部《公部門人工智慧應用參考手冊》V1.0，修訂頁記載 2026-01-28，第 25 頁；[原 PDF](https://www-api.moda.gov.tw/File/Get/moda/zh-tw/WwHCroVhwWy52dw#page=25)。本圖節錄頁面下半部提問文字，未改字，未含上方 Freepik 插畫；依[網站 CC0 宣告](https://moda.gov.tw/announcement/publicdeclare/951)保存。
...
在文章草稿的相關段落嵌入候選圖片或簡單示意圖，先檢查圖文是否表達相同意思。還沒取得的素材，以「待找圖片」註記寫明要說明什麼、從哪裡找及需要核對的內容。這些備課註記在交付前處理，不直接留給聽眾。

通讀文章，請 agent 建議刪重、合併與重排，由自己決定取捨。新資料補進素材筆記，論點有變就更新論點紀錄，留下棄案與理由。保存文章，供備講或作為聽眾的輔助閱讀材料。

#### 圖文補充｜直接看一句話如何改得更有依據

![文章修改前後：將所有人受益的籠統說法改成有研究情境與限制的敘述](../assets/week2-enrichment/paragraph-before-after.svg)

**優先：自擬改寫例子。** 左側是為教學刻意寫的過度概括，不是學員或研究作者的原話；右側依 [客服研究 v2 摘要](https://arxiv.org/abs/2304.11771v2)補入資料與限制。現場再用實作主題的一句話做相同練習。通讀與刪併直接看修改前後，不另畫一張與主流程重複的圖。

### 五、轉成投影片分頁，安排口述與畫面

從文章整理三到五頁分頁草稿，逐頁安排要傳達什麼、口述什麼、畫面呈現什麼，以及停留與換頁的節奏。文章保留完整脈絡，分頁依現場表達重新組織內容。

從前面累積的素材中選用，確認每張圖能幫助解釋本頁重點。研究數字核對原文與適用範圍，圖片保留來源與授權；生成圖標示示意。必要的短來源放在畫面，完整連結與說明保存在備註和素材筆記；授權要求的署名資訊一併保留。
...
- 本稿採三種畫面註記：**已取得圖片**嵌入原檔並附來源；**自繪示意**直接用 Mermaid 或文字版面草圖表達；**待找圖片**寫明用途、來源方向及核對事項。這些是講師的備課工具，不要求學員另填固定表格。
- 本次主線優先使用放大鏡照片、客服研究 Figure 3、台灣講座原頁、三種產出物對照、Zotero 示範畫面、數發部提問對照與文章修改例子。研究摘要圖與原圖擇一，台灣案例依時間挑選。雙鑽石、槓桿與 METR 留作備選，完整取捨見 [逐段選用紀錄](../kb/week2-paragraph-evidence-and-visuals.md)。
