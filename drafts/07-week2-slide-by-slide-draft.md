...
> 來源：[第二週主教案](02-week2-presentation-lesson-plan.md)、使用者六頁手稿及後續討論；相關素材為 `kb/presentation-process-before-and-after.md`、`kb/purposeful-reading-and-agent-assisted-practice.md`。本稿只引用現行教案已選用的概念，不重新展開舊 lesson 的移出主題。
...
這 22 頁是課程簡報。三到五頁演示簡報（主題待選），另在獨立專案現場做出來；本稿不預先填入其論點、版型選擇或結果。課前工具、資料設定與備援準備沿用主教案的講師備註。
...
前面先說明怎麼和 agent 合作，後面從空專案開始，做一份簡報。每完成一段，大家就跟著操作一段。

我們會留下論點、文章和投影片，至少把一條論點走到文章段落、分頁、排版與試講。演示簡報預計三到五頁，其餘依時間展開。

### 呈現與切換

先讓學員知道今天的範圍。此處交代任務，具體主題選定後再補充。
...
這個實作會從背景與材料開始，先想清楚要讓觀眾知道什麼，再形成論點、文章與投影片。先選一兩個和主題相關的例子深入看。

我會另開一個專案，現場做一段，大家跟一段。這樣素材、討論、取捨和成果都在同一個演示脈絡裡。

### 呈現與切換

此頁為實作轉場。正式授課投影片停在操作提示，演示簡報另在獨立專案中當場形成，不預寫演示結果。主題待選，選定後補入本頁。
...
一開始先大致說這個專案要做什麼，請它建立 kb，後續討論都保存進去。再把這個做法寫進 AGENTS.md，讓這次工作有共同的保存習慣。
...
接著聊背景和限制。先講自己的初步方向，例如想先說明觀眾會遇到的問題，再挑一兩個例子；讓 agent 提出補充。時間與篇幅用這次實際安排。
...
請 agent 協助查找與閱讀主題材料，選一兩個相關例子深入讀。自己也要看原文，才知道它整理得有沒有偏離。

把自己的相關經驗拿來比較。資料說了什麼、自己的觀察是什麼、哪些還要查，分開存進 kb，並保留來源與版本。
...
分頁內容確認後，請 agent 先提出一頁的排版做法，說明為什麼適合。必要格式和限制說清楚，其他細節讓它提出。

打開看成果，對照分頁草稿，檢查是否清楚表達出這頁的內容關係。合用後再展開其他頁。

### 呈現與切換

現場操作：切到分頁草稿與輸出頁面比較，提出具體修改。採用的 skills 或工具以備課測試結果為準，不預寫已成功輸出。
