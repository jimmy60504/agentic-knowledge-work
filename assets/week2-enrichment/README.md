...
2026-09-07 整體精簡後：主 draft 保留放大鏡、Figure 3、Zotero 三張圖片與三個 Mermaid。Double Diamond 圖移至 `kb/reference/week2-paragraph-evidence-and-visuals.md` 備講；原圖及授權不變。研究摘要與試講改用正文，其他已移出的文字圖片仍留查核。
