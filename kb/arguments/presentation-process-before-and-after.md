...
### 在研究案背景下用熟悉報告實作（2026-09-07，候選）

使用者提出：研究情境下可練習簡單介紹 paper，也可請學員使用自己寫過的報告，更容易比較 agent 的能力與自己原本想表達的內容。

Agent 建議將任務定為「向不熟悉這項研究的同事，說明一項自己熟悉的研究」，產出三到五頁簡報。優先使用自己寫過或熟悉、適合提供給工具的報告；無合適材料時用講師提供的短篇公開報告或 paper，不要求額外課前閱讀或作業。

實作先由人簡短說明受眾、最想保留的發現及不可誤解之處，再讓 agent 讀材料提出一段 draft／大綱；比較有用補充、重點遺漏、語意偏差與超出證據之處，提出一次具體修正，確認後製作 PPT。人的原始判斷與修改後版本都保存，避免只比較版面。搜尋由實際缺口觸發，例如補背景或核對引用，不要求每份熟悉報告都重新做文獻回顧。

這個練習可觀察兩件事：agent 能接手哪些整理與製作，以及它的表達是否符合人的研究理解。並非控制實驗，不能從單次結果推估普遍生產力效益。尚未整合主 draft，待使用者取捨。
