...
> 跨週共用的選材入口，2026-09-19 建立。課程討論前先讀這份，再按題目讀相關筆記與 draft。這裡記錄有哪些想法、可以怎麼用、目前用到哪裡；不預先分配未定週次。

## 怎麼看與回存

- **候選**：尚未放進目前主線，可依需求取用。
- **部分採用**：已有一部分進入 draft，延伸內容仍可選；採用不代表整個主題用完。
- **講師參考**：用於設計課程或協助討論，不預設要教給學員。
- **暫不採用**：保留理由與來源，避免下次又自動放回。

每列只留想法、用途、狀態與連結。完整來源與洞見放在 `kb/reference/`、`kb/arguments/`、`kb/tools/`；尚無來源的討論連回[工作紀錄](../工作紀錄.md)。每週從索引挑進 draft，收斂時將超出範圍的內容補回原筆記並更新索引。若沒有合適筆記，先存工作紀錄或依既有 KB 規則新建主題筆記，不為每次取捨另開一份素材清單。
...
| Domain storytelling | 演員、工作物件、編號活動三個元素畫一個具體案例；三元素對上工作單的誰做、材料與產物、步驟 | 部分採用：4-1 第 3 頁已用此畫法，使用者 2026-09-22 提出整份演講的流程圖可統一用它。[筆記](tools/domain-storytelling.md)，來源待查核 |
...
| 地震預警 2024 花蓮事件檢討 | 預警四段流程各幾秒、發布門檻、0403 漏報七縣市的四項原因與四項改善、0816 事件驗證、年度時效統計；管線內的機器學習模型即「固定節點呼叫一次模型」 | 候選：第四週貫穿案例的替代方案（事後檢討取代測站斷訊）、介入方式第四種實例、完成證據實例。[演講投影片筆記](reference/cwa-earthquake-center/cwa-eew-2024-hualien-case-study.md)。中心同仁的公開檢討，引用時以流程為主、不評論事件。2026-09-22 起不再作第四週貫穿案例（改為研究想法測試），保留為背景資料 |
...
| 材料／安排 | 為什麼先留下、不自動放回 | 來源 |
|---|---|---|
| 客服 AI 研究數字與圖表 | 使用者認為不好講；需要適合的受眾或例子才重新評估 | [研究筆記](arguments/ai-amplifier-evidence-and-visuals.md) |
| 業務簡報四種方式、完整形式巡禮、長篇備課史 | 分類與示範目的曾不一致，也容易只對講師有意義；保留小例子，不恢復成主線 | [對照組](arguments/baseline-deck-looks-good-but-cannot-present.md)、[歷次取捨](../archive/week2-2026-09-19/deferred-materials.md) |
| 藍色試作、舊逐頁稿、完整原話稿 | 保留設計與取捨歷史；不與正式 34 頁版混用 | [第二週歷史索引](../archive/week2-2026-09-19/README.md) |
| 十條張力、四圈候選、360 分鐘長版 | 使用者先前要求移出，不因本次收納恢復 | [工作紀錄](../工作紀錄.md)、[第四週原底稿](../archive/week4-2026-09-19/11-week4-workflow-outline.md) |
| 強制課前問卷、回家閱讀、省時日誌、檢查點、互評與交件 | 維持課內自由操作、不增加課外負擔；不是待排的新主題 | [歷次取捨](../archive/week2-2026-09-19/deferred-materials.md)、[工作紀錄](../工作紀錄.md) |
| 一概而論的能力、記憶、摘要、合規與效益說法 | 只留下待驗證問題；不能把資料夾當合規保證，或將廠商數字當本課成果 | [歷次取捨](../archive/week2-2026-09-19/deferred-materials.md)、各主題來源 |

## 各週採用、回顧與正本

採用紀錄持續累加，不能只留下最近一次位置。**已入正式教材**與**已入 draft**分開記；後者不代表已授課。後續回顧要說明這次補上什麼，不必把原段落全部重講。未排定的回顧只記用途，不指定週次。

下表「第二週」連到[正式文章](../lessons/01-presentation-and-the-knowledge-work-loop.qmd)；「第四週前半／後半」連到[講課 draft](../drafts/03-week4-lecture.md)與[工作坊 draft](../drafts/04-week4-agent-value-workshop.md)；第四週正式文章為 [4-1](../lessons/02-agent-and-methods.qmd)、[4-2](../lessons/03-back-to-your-work.qmd)、[4-3](../lessons/04-workshop-find-agent-use.qmd)。章節名稱供快速定位。
...
素材可以多次進入不同週次。每次討論與試作補出的證據、反例、條件與取捨，先回到來源筆記；當想法已形成完整、經使用者確認的概念，就整理到 `ssot/`，不能讓最完整的版本只留在某週 draft。

- 概念正本保存完整定義、推論、適用範圍、限制、例子及必要的圖，連回來源與演變紀錄，附版本與修改理由。
- 已有相同主題正本就更新，不另建平行版本；索引標出正本連結與各週採用位置。只有進過課程，不能直接視為已成熟定案。
- 後續章節從正本取用、回顧或深化；新發現改變概念時先更新正本，再同步仍在編修的 draft。已發布週次保留當時版本與用語。
- KB 保留來源、證據與想法形成過程；SSOT 保存目前完整定案的理解；skills／AGENTS.md 保存可重複執行的工作標準。三者互連，不因升格就刪除來源。

本索引整併原「第二週移出素材」、第四週候選池與課程地圖的點子庫。完整歷次取捨保留在[歷史紀錄](../archive/week2-2026-09-19/deferred-materials.md)與[工作紀錄](../工作紀錄.md)，不與本索引並行更新。
